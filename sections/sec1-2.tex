...
\begin{proposition}\label{prop:eigenvaluesforDs}
  ...
  \begin{align}
    ...
    \end{aligned}
  \end{align}
\end{proposition}\todo{I might want to change the result slightly. What happens if $R_{\ell+1}=0$, then we should have $\dd{\ell}{+}=0$, I either need to change the result or go back through the paper and correct some things and argue that this will not happen/will not matter}
\begin{proof}
