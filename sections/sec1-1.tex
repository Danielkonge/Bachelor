...
\begin{align}\label{eq:Drels}
  ...
  \end{aligned}
\end{align}
Note that for $m\in\Set{\pm\ell}$, where the $\widetilde D_-$ term vanishes.\fancybreak{* \quad * \quad * \quad * \quad *}
...
\begin{align}\label{eq:Factions}
  \begin{aligned}
    F_3 \xi &= \sqrt{\ell^2-m^2}\psi \widetilde D_-(e_m) - m\psi \widetilde D_0(e_m) - \sqrt{(\ell+1)^2-m^2}\psi \widetilde D_+(e_m), \\
