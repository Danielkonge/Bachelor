...
\begin{proof}
  ...
  \end{align*}
  for $\xi \in R_{\ell_0,m_0}$ by \cref{eq:Deltastemp}. Also by \cref{eq:dformulaeonR_l} we get that... \todo{Finish this later --- try to use Theorem~1.19 more. Start with the pair $(R_{\ell_0,m_0},a)$ and choose $E_+$, $E_-$, $D_+$ after choosing basis where $a$ has matrix representation $[a_0]$}
\end{proof}
