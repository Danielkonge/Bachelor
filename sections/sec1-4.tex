...
\end{align*}
for $\xi \in R_{\abs{\ell_1},m_0}$. Again since $D_+D_-$ and $\delta$ are nilpotent on $R_{\abs{\ell_1},m_0}$ by assumption, we see that $\Delta_1^2$ only has the eigenvalue $-\ell_0^2\ell_1^2$...\todo{Change the above, be more precise with $\Delta_2$ and reword somethings with $\Delta_1$ --- want to say $\Delta_1$ is uniquely determined}
